...
VEO_REFERENCE_SUBJECT_MODELS = {
    "veo-3.1-preview",
    "veo-3.1-fast-preview",
    "veo-3.1-generate-preview",
    "veo-3.1-fast-generate-preview",
}
VEO_REFERENCE_SUBJECT_MAX_IMAGES = 3
SEEDANCE_REFERENCE_IMAGE_MAX_IMAGES = 4
VERTEX_LAST_FRAME_SUPPORTED_MODELS = {
    "veo-3.1",
    "veo-3.1-fast",
    "veo-3.1-preview",
    "veo-3.1-fast-preview",
...
SEEDANCE_LAST_FRAME_SUPPORTED_MODELS = {
    "seedance-1-5-pro",
    "seedance-1-0-pro",
